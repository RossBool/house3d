...
function stdFloor(z, level) {
  ...
  return {
    ...
    walls: [
      ...
      { a: [3.5, 5.5], b: [7.0, 5.5], t: 0.2, h: H_STD, name: '单间北墙', ops: [] },
    ...
    furniture: [
      { type: 'toilet', pos: [0.45, -0.5], rot: -Math.PI / 2 },
      { type: 'basin', pos: [0.9, -0.9], rot: 0, s: 0.7 },
      { type: 'lSofa', pos: [0.59, 2.0], rot: 0, s: 0.55 },
      { type: 'kitchenCounter', pos: [0.9, 4.3], rot: 0, s: 0.3 },
      { type: 'bed', pos: [5.6, -0.14], rot: 0 },
      { type: 'wardrobe', pos: [4.38, 0.4], rot: Math.PI / 2, s: 0.7 },
      { type: 'lSofa', pos: [4.9, 3.37], rot: 0, s: 0.7 },
      { type: 'coffeeTable', pos: [6.4, 3.4], rot: Math.PI / 2 },
      { type: 'tvUnit', pos: [4.85, 5.24], rot: 0 },
      { type: 'bed', pos: [8.76, 1.05], rot: Math.PI / 2, s: 0.8 },
      { type: 'bathtub', pos: [7.9, -0.65], rot: 0 },
      { type: 'toilet', pos: [9.7, -0.65], rot: 0 },
      { type: 'basin', pos: [10.9, -0.65], rot: 0 },
      { type: 'bed', pos: [5.15, 6.71], rot: 0 },
      { type: 'wardrobe', pos: [4.0, 7.5], rot: Math.PI / 2, s: 0.75 },
      { type: 'table4', pos: [7.75, 8.4], rot: 0 },
      { type: 'kitchenCounter', pos: [10.85, 5.5], rot: 0, s: 0.4 },
      { type: 'toilet', pos: [11.49, 8.4], rot: -Math.PI / 2 },
      { type: 'basin', pos: [10.9, 7.85], rot: -Math.PI / 2 },
      { type: 'table4', pos: [8.32, 10.5], rot: 0, s: 0.7 },
      { type: 'kitchenCounter', pos: [10.85, 12.0], rot: 0, s: 0.4 },
      { type: 'toilet', pos: [11.49, 10.1], rot: -Math.PI / 2 },
      { type: 'basin', pos: [10.9, 10.9], rot: -Math.PI / 2 },
      { type: 'bed', pos: [9.45, 14.375], rot: 0, s: 0.65 },
      { type: 'bed', pos: [9.5, 16.56], rot: 0 },
      { type: 'wardrobe', pos: [10.6, 18.2], rot: Math.PI, s: 0.65 },
      { type: 'toilet', pos: [11.49, 19.2], rot: -Math.PI / 2 },
      { type: 'basin', pos: [10.7, 19.45], rot: Math.PI },
      { type: 'kitchenCounter', pos: [1.28, 14.4], rot: -Math.PI / 2, s: 0.35 },
      { type: 'bed', pos: [1.75, 16.68], rot: 0 },
      { type: 'wardrobe', pos: [1.7, 18.1], rot: Math.PI, s: 0.5 },
      { type: 'lSofa', pos: [3.9, 18.5], rot: 0, s: 0.7 },
...
function bigFloor(z, level) {
  ...
  return {
    ...
    walls: [
      ...
      { a: [6.9, 0.1], b: [11.9, 0.1], t: 0.12, h: H_STD, name: '东北浴卫南墙', ops: [
        { o: 3.45, w: 0.7, s: 0, h: 2.1, type: 'door', code: 'M0721', swing: ['n', -1] },
      ]},
      { a: [8.4, -1.3], b: [8.4, 0.1], t: 0.12, h: H_STD, name: '东北浴室卫生间隔墙', ops: [
        { o: 0.7, w: 0.8, s: 0, h: 2.1, type: 'pass', code: '洞口' },
      ]},
      { a: [10.0, -1.3], b: [10.0, 0.1], t: 0.12, h: H_STD, name: '东北卫生盥洗隔墙', ops: [
        { o: 0.75, w: 0.8, s: 0, h: 2.1, type: 'pass', code: '洞口' },
      ]},
    ...
    rooms: [
      ...
      { id: 'bs3', name: '浴室', bbox: [6.95, -1.1, 8.35, -0.05], floor: 'tile' },
      { id: 'ws3', name: '卫生间', bbox: [8.45, -1.1, 9.95, -0.05], floor: 'tile' },
      { id: 'xj3', name: '盥洗区', bbox: [10.05, -1.1, 11.8, -0.05], floor: 'tile' },
      { id: 'wdC', name: '卧室 22.54㎡', bbox: [7.2, 0.15, 11.75, 3.65], floor: 'wood' },
    ...
    furniture: [
      { type: 'toilet', pos: [1.45, -0.9], rot: 0 },
      { type: 'basin', pos: [0.42, -0.9], rot: -Math.PI / 2 },
      { type: 'bed', pos: [1.2, 2.45], rot: Math.PI / 2 },
      { type: 'wardrobe', pos: [1.37, 3.97], rot: Math.PI, s: 0.9 },
      { type: 'bed', pos: [5.3, -0.14], rot: 0 },
      { type: 'wardrobe', pos: [5.5, 2.97], rot: Math.PI, s: 0.9 },
      { type: 'bed', pos: [8.4, 1.8], rot: 0 },
      { type: 'wardrobe', pos: [8.5, 0.42], rot: 0, s: 0.85 },
      { type: 'bed', pos: [8.6, 5.02], rot: 0 },
      { type: 'basin', pos: [7.7, 10.75], rot: Math.PI / 2 },
      { type: 'toilet', pos: [10.08, 10.35], rot: -Math.PI / 2 },
      { type: 'wardrobe', pos: [10.25, 12.0], rot: 0, s: 0.85 },
      { type: 'wardrobe', pos: [9.6, 11.6], rot: 0, s: 0.8 },
      { type: 'tvUnit', pos: [1.55, 13.86], rot: Math.PI },
      { type: 'sofa3', pos: [1.85, 17.25], rot: Math.PI / 2, s: 0.75 },
      { type: 'sofa3', pos: [0.36, 16.15], rot: 0, s: 0.6 },
      ...
      { type: 'basin', pos: [11.3, 16.45], rot: -Math.PI / 2 },
      { type: 'toilet', pos: [9.0, -0.85], rot: 0 },
      { type: 'basin', pos: [10.95, -0.8], rot: 0 },
    ],
  };
}
...
const FLOORS = [
  ...
  },
  {
    ...
    furniture: [
      { room: 'woshi', type: 'bed', pos: [2.34, 2.1], rot: -Math.PI / 2, name: '双人床', desc: '1800×2000 双人床，床头贴东墙（图纸原位），西侧 C1818 窗纳景。' },
      { room: 'woshi', type: 'nightstand', pos: [3.19, 0.85], rot: 0, name: '床头柜', desc: '500×500 实木床头柜，上置台灯（图纸原位）。' },
      { room: 'woshi', type: 'nightstand', pos: [3.19, 3.35], rot: 0, name: '床头柜', desc: '500×500 实木床头柜，上置台灯（图纸原位）。' },
      { room: 'wsF', type: 'toilet', pos: [2.55, -0.65], rot: Math.PI, name: '坐便器', desc: '坐便器，排污管沿墙暗敷。' },
      ...
      { room: 'xyj', type: 'laundry', pos: [11.0, -0.6], rot: 0, name: '洗衣机组', desc: '洗衣机+烘干机并列，北墙 C0714 通风采光。' },
      { room: 'canting', type: 'diningSet', pos: [6.25, 2.65], rot: 0, name: '十人圆餐桌', desc: 'Ø1800 圆桌配十椅，居餐厅正中，家宴待客。' },
      { room: 'chufang', type: 'kitchenCounter', pos: [9.65, 0.4], rot: 0, s: 0.3, name: 'L 型橱柜', desc: 'L 型台面沿北墙与东墙：双灶+双槽水槽，上方吊柜。' },
      { room: 'chufang', type: 'fridge', pos: [10.0, 3.9], rot: 0, name: '冰箱', desc: '双门冰箱置于南端，紧邻 M2427 取餐动线。' },
      { room: 'guoting', type: 'sofa3', pos: [9.65, 5.9], rot: -Math.PI / 2, s: 0.8, name: '三人沙发', desc: '三人沙发贴北墙布置，面向南侧电视墙——图纸原位。' },
      { room: 'guoting', type: 'armchair', pos: [8.45, 6.9], rot: 0, name: '扶手椅', desc: '西侧扶手椅，与东侧成对。' },
      { room: 'guoting', type: 'armchair', pos: [10.85, 6.9], rot: Math.PI, name: '扶手椅', desc: '东侧扶手椅，与西侧成对。' },
      ...
      { room: 'guoting', type: 'tvUnit', pos: [9.9, 8.63], rot: 0, name: '电视柜', desc: '长几贴南墙，与沙发组相对——图纸原位。' },
      { room: 'chashi', type: 'shelf', pos: [5.6, 9.72], rot: 0, name: '博古架', desc: '北墙 2400 长博古架，陈列紫砂壶、茶盏与茶宠——业主指定补置。' },
      ...
      { room: 'chashi', type: 'chair', pos: [7.35, 10.6], rot: 0, name: '茶凳', desc: '茶桌两侧茶凳之一。' },
      { room: 'chashi', type: 'chair', pos: [7.35, 12.4], rot: Math.PI, name: '茶凳', desc: '茶桌两侧茶凳之二。' },
