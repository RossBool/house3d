...
function stdFloor(z, level) {
  return {
    ...
    furniture: [
      ...
      { type: 'teaTable', pos: [4.9, 11.85], rot: 0 },
      { type: 'sofa3', pos: [3.9, 16.9], rot: 0 },
      { type: 'coffeeTable', pos: [4.72, 16.7], rot: Math.PI / 2 },
...
function bigFloor(z, level) {
  return {
    ...
    furniture: [
      ...
      { type: 'wardrobe', pos: [3.7, 4.06], rot: 0, s: 0.9 },
      { type: 'wardrobe', pos: [5.95, 4.12], rot: 0, s: 0.76 },
      ...
      { type: 'armchair', pos: [3.35, 15.5], rot: Math.PI },
      { type: 'armchair', pos: [3.35, 17.6], rot: Math.PI },
      { type: 'coffeeTable', pos: [2.85, 16.6], rot: 0 },
...
const FLOORS = [
  ...
  },
  {
    ...
    furniture: [
      ...
      { room: 'bath', type: 'toilet', pos: [1.02, 1.12], rot: Math.PI / 2, name: '坐便器', desc: '连体坐便器，排污管按图纸沿墙暗敷。' },
      ...
      { room: 'canting', type: 'diningSet', pos: [5.45, 2.75], rot: 0, s: 0.93, name: '十人圆餐桌', desc: 'Ø1800 圆桌配十椅——与图纸家具布置完全一致，家宴待客皆宜。' },
      { room: 'canting', type: 'sideboard', pos: [3.85, 1.35], rot: 0, name: '餐边柜', desc: '2200 长餐边柜贴西墙，收纳茶器酒具。' },
      ...
      { room: 'guoting', type: 'sofa1', pos: [9.25, 8.25], rot: Math.PI, name: '单人沙发', desc: '组合沙发配位之二。' },
      ...
      { room: 'guoting', type: 'plant', pos: [10.08, 9.05], rot: 0, name: '绿植', desc: '客厅东南角绿植。' },
      ...
      { room: 'chashi', type: 'shelf', pos: [5.60, 9.86], rot: 0, name: '博古架', desc: '北墙 2400 长博古架，陈列茶器。' },
      ...
      { room: 'shufang', type: 'armchair', pos: [7.95, 12.35], rot: -Math.PI / 4, name: '单人沙发', desc: '窗边休闲位。' },
