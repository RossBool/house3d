...
function stdFloor(z, level) {
  ...
  return {
    ...
    furniture: [
      ...
      { type: 'plant', pos: [2.6, -0.6], rot: 0 },
      { type: 'lSofa', pos: [1.1, 1.8], rot: 0 },
      { type: 'kitchenCounter', pos: [1.2, 3.82], rot: 0, s: 0.45 },
      { type: 'bed', pos: [5.25, 0.65], rot: 0 },
      { type: 'nightstand', pos: [4.0, 0.5], rot: 0 },
      { type: 'nightstand', pos: [6.5, 0.5], rot: 0 },
      ...
      { type: 'bed', pos: [5.25, 8.5], rot: Math.PI },
      { type: 'nightstand', pos: [4.0, 9.05], rot: 0 },
      { type: 'nightstand', pos: [6.5, 9.05], rot: 0 },
      { type: 'toilet', pos: [10.75, 8.1], rot: -Math.PI / 2 },
      { type: 'diningSet', pos: [8.3, 7.6], rot: 0, s: 0.85 },
      { type: 'kitchenCounter', pos: [10.75, 5.95], rot: 0, s: 0.4 },
      { type: 'diningSet', pos: [8.3, 11.5], rot: 0, s: 0.8 },
      { type: 'kitchenCounter', pos: [10.75, 11.95], rot: 0, s: 0.4 },
      { type: 'toilet', pos: [11.2, 10.2], rot: -Math.PI / 2 },
      { type: 'bed', pos: [9.45, 14.5], rot: 0, s: 0.65 },
      { type: 'bed', pos: [9.5, 17.4], rot: 0 },
      { type: 'plant', pos: [8.4, 19.3], rot: 0 },
      { type: 'basin', pos: [10.5, 19.3], rot: Math.PI },
      { type: 'kitchenCounter', pos: [1.4, 13.95], rot: 0, s: 0.45 },
      { type: 'bed', pos: [1.7, 17.4], rot: 0 },
      { type: 'plant', pos: [2.8, 19.3], rot: 0 },
...
function bigFloor(z, level) {
  ...
  return {
    ...
    walls: [
      ...
      { a: [3.5, 13.5], b: [3.5, 20.0], t: 0.2, h: H_STD, name: '客厅餐厅隔墙', ops: [
        { o: 1.7, w: 0.9, s: 0, h: 2.1, type: 'door', code: 'M0921', swing: ['w', -1] },
      ]},
    ...
    rooms: [
      ...
      { id: 'kt', name: '客厅', bbox: [0.2, 13.8, 3.35, 19.8], floor: 'wood' },
      { id: 'ct', name: '餐厅', bbox: [3.7, 13.8, 6.85, 19.8], floor: 'wood' },
    ...
    furniture: [
      ...
      { type: 'bed', pos: [8.6, 5.7], rot: -Math.PI / 2 },
      ...
      { type: 'sofa3', pos: [0.65, 15.9], rot: 0 },
      { type: 'coffeeTable', pos: [1.9, 15.9], rot: Math.PI / 2 },
      { type: 'tvUnit', pos: [1.7, 14.15], rot: 0 },
      { type: 'plant', pos: [0.6, 18.9], rot: 0 },
      { type: 'diningSet', pos: [5.25, 16.8], rot: 0, s: 0.9 },
      { type: 'bed', pos: [8.3, 16.45], rot: -Math.PI / 2 },
      { type: 'nightstand', pos: [8.35, 14.95], rot: 0 },
      { type: 'nightstand', pos: [8.35, 17.95], rot: 0 },
      { type: 'toilet', pos: [11.3, 17.0], rot: -Math.PI / 2 },
      { type: 'basin', pos: [11.3, 15.95], rot: -Math.PI / 2 },
      { type: 'toilet', pos: [10.15, -0.62], rot: 0 },
      { type: 'plant', pos: [6.5, 12.8], rot: 0 },
    ],
  };
}
...
const FLOORS = [
  ...
  },
  {
    ...
    rooms: [
      ...
      { id: 'chashi', name: '茶室', bbox: [3.7, 9.7, 11.75, 13.3], floor: 'wood',
        ...
        desc: '茶室约 34㎡，曲尺大榻围合品茗区；北通会客厅，南 M1627 推拉门整片开启直入露台。”' },
    ...
    furniture: [
      { room: 'woshi', type: 'bed', pos: [1.5, 2.3], rot: Math.PI / 2, name: '双人床', desc: '1800×2000 双人床，床头板贴东墙隔墙，西侧 C1818 窗纳景。' },
      { room: 'woshi', type: 'nightstand', pos: [3.05, 1.25], rot: 0, name: '床头柜', desc: '500×500 实木床头柜，上置台灯。' },
      { room: 'woshi', type: 'nightstand', pos: [3.05, 3.35], rot: 0, name: '床头柜', desc: '500×500 实木床头柜，上置台灯。' },
      ...
      { room: 'guoting', type: 'sofa3', pos: [10.3, 6.4], rot: Math.PI / 2, name: '三人沙发', desc: '三人沙发临东墙 C2018，面向西侧电视墙。' },
      { room: 'guoting', type: 'coffeeTable', pos: [10.3, 7.6], rot: 0, name: '茶几', desc: '矮茶几配沙发组。' },
      { room: 'guoting', type: 'tvUnit', pos: [8.15, 9.1], rot: 0, name: '电视柜', desc: '电视柜贴南侧隔墙，与沙发组相对。' },
      { room: 'chashi', type: 'lSofa', pos: [5.6, 11.55], rot: 0, name: '曲尺大榻', desc: 'L 型曲尺沙发榻围合品茗区，图纸原位。' },
      { room: 'chashi', type: 'teaTable', pos: [7.0, 11.35], rot: 0, name: '茶桌', desc: '1500×900 矮茶桌，上置整套茶具。' },
      { room: 'chashi', type: 'rug', pos: [6.3, 11.5], rot: 0, name: '地毯', desc: '茶区羊毛地毯。' },
      { room: 'chashi', type: 'plant', pos: [11.2, 12.8], rot: 0, name: '盆景', desc: '松柏盆景，与露台绿意呼应。' },
      { room: 'guoke', type: 'plant', pos: [6.4, 6.3], rot: 0, name: '绿植', desc: '过厅东北角绿植。' },
      { room: 'lutai', type: 'flowerPool', pos: [0.15, 19.8], rot: 0, name: '弧形花池', desc: '西南角 1/4 圆弧花池，内植灌木球——对应图纸西南角弧形构筑。' },
      { room: 'lutai', type: 'outdoorSet', pos: [7.6, 16.3], rot: 0, name: '户外桌椅', desc: '藤编双椅+小圆桌+遮阳伞，露台会客角。' },
      { room: 'lutai', type: 'lounger', pos: [3.6, 15.6], rot: 0.35, name: '躺椅', desc: '南向日光躺椅之一。' },
      { room: 'lutai', type: 'lounger', pos: [4.9, 15.6], rot: 0.35, name: '躺椅', desc: '南向日光躺椅之二。' },
      { room: 'lutai', type: 'plant', pos: [0.75, 14.4], rot: 0, name: '盆栽', desc: '露台西北角盆栽。' },
      { room: 'lutai', type: 'plant', pos: [9.9, 19.1], rot: 0, name: '盆栽', desc: '露台东南角盆栽。' },
    ],
    mark: [4.8, 7.5, '26.900'],
  },
  ...
  },
  {
    ...
    walls: [
      { a: [3.4, 5.3], b: [10.8, 5.3], t: 0.2, h: 2.9, name: '北外墙', ops: [] },
      { a: [10.8, 5.3], b: [10.8, 13.7], t: 0.2, h: 2.9, name: '东外墙', ops: [] },
      { a: [3.4, 13.7], b: [10.8, 13.7], t: 0.2, h: 2.9, name: '南外墙', ops: [] },
      { a: [3.4, 5.3], b: [3.4, 13.7], t: 0.2, h: 2.9, name: '西外墙', ops: [] },
    ...
    rooms: [
      { id: 'lt', name: '楼梯间', bbox: [3.55, 5.45, 5.9, 7.7], floor: 'stone', stair: true, b1: true },
      { id: 'cc', name: '储藏间', bbox: [3.55, 7.9, 10.65, 13.55], floor: 'cement' },
      { id: 'cc2', name: '储藏间', bbox: [6.15, 5.45, 10.65, 7.7], floor: 'cement' },
    ],
    furniture: [],
    mark: [4.6, 9.6, '-3.000'],
  },
