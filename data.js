...
function stdFloor(z, level) {
  ...
  return {
    ...
    furniture: [
      ...
      { type: 'lSofa', pos: [0.59, 1.8], rot: 0 },
      { type: 'kitchenCounter', pos: [1.2, 3.82], rot: 0, s: 0.45 },
      { type: 'bed', pos: [5.35, -0.14], rot: 0 },
      { type: 'wardrobe', pos: [3.77, 0.4], rot: Math.PI / 2, s: 0.7 },
      { type: 'lSofa', pos: [4.2, 2.97], rot: 0, s: 0.7 },
      { type: 'coffeeTable', pos: [6.1, 2.85], rot: 0 },
      { type: 'tvUnit', pos: [4.85, 5.24], rot: 0 },
      { type: 'bed', pos: [8.16, 1.05], rot: Math.PI / 2, s: 0.8 },
      { type: 'bathtub', pos: [7.9, -0.65], rot: 0 },
      { type: 'toilet', pos: [9.7, -0.65], rot: 0 },
      { type: 'basin', pos: [10.9, -0.65], rot: 0 },
      { type: 'bed', pos: [5.1, 6.66], rot: 0 },
      { type: 'wardrobe', pos: [3.79, 7.4], rot: Math.PI / 2, s: 0.75 },
      ...
      { type: 'bed', pos: [1.75, 16.76], rot: 0 },
      { type: 'wardrobe', pos: [0.7, 18.19], rot: Math.PI, s: 0.5 },
...
function bigFloor(z, level) {
  ...
  return {
    ...
    furniture: [
      ...
      { type: 'wardrobe', pos: [1.0, 4.58], rot: Math.PI, s: 0.9 },
      { type: 'bed', pos: [5.3, -0.14], rot: 0 },
      { type: 'wardrobe', pos: [5.5, 3.62], rot: Math.PI, s: 0.9 },
      { type: 'bed', pos: [8.4, 1.8], rot: 0 },
      { type: 'wardrobe', pos: [8.5, 0.42], rot: 0, s: 0.85 },
      { type: 'bed', pos: [8.3, 4.91], rot: 0 },
      ...
      { type: 'toilet', pos: [9.5, -0.6], rot: 0 },
      { type: 'basin', pos: [10.85, -0.7], rot: 0 },
    ],
  };
}
...
const FLOORS = [
  ...
  },
  {
    ...
    furniture: [
      { room: 'woshi', type: 'bed', pos: [2.34, 1.85], rot: -Math.PI / 2, name: '双人床', desc: '1800×2000 双人床，床头贴东墙（图纸原位），西侧 C1818 窗纳景。' },
      { room: 'woshi', type: 'nightstand', pos: [3.19, 0.6], rot: 0, name: '床头柜', desc: '500×500 实木床头柜，上置台灯（图纸原位）。' },
      { room: 'woshi', type: 'nightstand', pos: [3.19, 3.15], rot: 0, name: '床头柜', desc: '500×500 实木床头柜，上置台灯（图纸原位）。' },
      { room: 'wsF', type: 'toilet', pos: [2.95, -0.55], rot: Math.PI, name: '坐便器', desc: '坐便器，排污管沿墙暗敷。' },
      ...
      { room: 'guoting', type: 'tvUnit', pos: [9.9, 9.24], rot: 0, name: '电视柜', desc: '长几贴南墙，与沙发组相对——图纸原位。' },
